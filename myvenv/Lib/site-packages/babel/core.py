...
class Locale:
    ...
    def negotiate(
        ...
        :param preferred: the list of locale identifiers preferred by the users
...
def negotiate_locale(preferred: Iterable[str], available: Iterable[str], sep: str = '_', aliases: Mapping[str, str] = LOCALE_ALIASES) -> str | None:
    ...
    users to easily add the territory. So while you may prefer using qualified
    ...
    :param preferred: the list of locale strings preferred by the users
