...
``SavingsAccount`` entry in the list of accounts for this users.   The
...
.. sourcecode:: pycon+sql
    ...
    ... )
    {printsql}SELECT "users".id AS user_id, "users".name AS user_name,
    account.balance AS account_balance
    FROM "users" JOIN account ON "users".id = account.user_id
...
.. sourcecode:: pycon+sql
    ...
    {printsql}SELECT "users".id AS user_id, "users".name AS user_name,
    account.balance AS account_balance
    FROM "users" LEFT OUTER JOIN account ON "users".id = account.user_id
...
.. sourcecode:: pycon+sql
    ...
    {printsql}SELECT "users".id, "users".name
    FROM "users"
    WHERE (
