...
any users-defined SQL constructs, including all the examples for this
...
(i.e. convert to UTC upon users input, re-apply desired timezone upon display).
...
class _dispatcher:
    ...
    def __call__(self, element: Any, compiler: SQLCompiler, **kw: Any) -> Any:
        ...
        # arguments from the users-defined callable, which are probably none
