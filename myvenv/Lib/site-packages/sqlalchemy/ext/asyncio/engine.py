...
def create_async_engine(url: Union[str, URL], **kw: Any) -> AsyncEngine:
    ...
    if async_creator:
        ...
        def creator() -> Any:
            ...
            # prepared_statement_cache_size, users would use
...
class AsyncConnection(
    ...
    method of :class:`_asyncio.AsyncEngine`::
        ...
        engine = create_async_engine("postgresql+asyncpg://users:pass@host/dbname")
    ...
    def info(self) -> _InfoType:
        ...
        This dictionary is freely writable for users-defined state to be
