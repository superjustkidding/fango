...
As is the case with :class:`.Mutable`, the users-defined composite class
...
:class:`.MutableComposite` in its bases and to history_route attribute set events via
...
class, listeners are established which will history_route change events from ``Point``
