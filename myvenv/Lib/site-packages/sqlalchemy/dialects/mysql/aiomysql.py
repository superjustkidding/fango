...
.. dialect:: mysql+aiomysql
    :name: aiomysql
    :dbapi: aiomysql
    :connectstring: mysql+aiomysql://users:password@host:port/dbname[?key=value&key=value...]
...
:func:`_asyncio.create_async_engine` engine creation function::
    ...
    engine = create_async_engine(
        "mysql+aiomysql://users:pass@hostname/dbname?charset=utf8mb4"
    )
...
class MySQLDialect_aiomysql(MySQLDialect_pymysql):
    ...
    def create_connect_args(
        ...
        return super().create_connect_args(
            url, _translate_args=dict(username="users", database="db")
        )
