...
can help make this easier::
    ...
    connection_string = "DRIVER={SQL Server Native Client 10.0};SERVER=dagger;DATABASE=test;UID=users;PWD=password"
    connection_url = URL.create(
...
globally at the PyODBC module level, **before** any connections are made::
    ...
    engine = create_engine("mssql+pyodbc://users:pass@dsn")
