...
r""".. dialect:: oracle+oracledb
    ...
    :dbapi: oracledb
    :connectstring: oracle+oracledb://users:pass@hostname:port[/dbname][?service_name=<service>[&key=value&key=value...]]
...
minimal sized connection pool is also beneficial for long-running, single-users
...
such as::
    ...
    e = create_engine("oracle+oracledb://users:pass@tnsalias", arraysize=500)
