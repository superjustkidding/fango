...
r""".. dialect:: oracle+cx_oracle
    :name: cx-Oracle
    :dbapi: cx_oracle
    :connectstring: oracle+cx_oracle://users:pass@hostname:port[/dbname][?service_name=<service>[&key=value&key=value...]]
...
symbol::
    ...
    e = create_engine(
        "oracle+cx_oracle://users:pass@dsn?encoding=UTF-8&nencoding=UTF-8&mode=SYSDBA&events=true"
    )
...
Any cx_Oracle parameter value and/or constant may be passed, such as::
    ...
    e = create_engine(
        "oracle+cx_oracle://users:pass@dsn",
        connect_args={
            "encoding": "UTF-8",
            "nencoding": "UTF-8",
...
, such as::
    ...
    e = create_engine(
        "oracle+cx_oracle://users:pass@dsn", coerce_to_decimal=False
    )
...
As well as providing a scalable solution for multi-users applications, the
