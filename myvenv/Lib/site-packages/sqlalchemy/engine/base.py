...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        method accepts any arbitrary parameters including users defined names.
    ...
    def info(self) -> _InfoType:
        ...
        referred to by this :class:`_engine.Connection`, allowing users-defined
    ...
    def _handle_dbapi_exception(
        ...
        try:
            ...
            if (self.dialect._has_events) and not self._execution_options.get(
                ...
                # set up potentially users-defined value for
                # invalidate pool.
                invalidate_pool_on_disconnect = (
