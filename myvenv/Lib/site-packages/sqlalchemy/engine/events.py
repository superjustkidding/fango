...
class ConnectionEvents(event.Events[ConnectionEventsTarget]):
    ...
    :param retval=False: Applies to the :meth:`.before_execute` and
      ...
      users-defined event function must have a return value, which
...
class DialectEvents(event.Events[Dialect]):
    ...
    def handle_error(
        ...
        * exception re-writing
        ...
        the SQLAlchemy-constructed exception into one that is users
        ...
        .. warning::  Because the
           ...
           **stack traces will be misleading** if the users-defined event
    ...
    def do_connect(
        ...
        dictionary that may also be mutated::
            ...
            e = create_engine("postgresql+psycopg2://users@host/dbname")
