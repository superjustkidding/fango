...
def listen(
    ...
    :param bool insert: The default behavior for event handlers is to append
      the decorated users defined function to an internal list of registered
      event listeners upon discovery. If a users registers a function with
      ...
      certain users defined functions can run before others, such as when
