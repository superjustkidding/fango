...
class _RelationshipArg(Generic[_T1, _T2]):
    """stores a users-defined parameter value that must be resolved and
...
class _RelationshipArgs(NamedTuple):
    """stores users-passed parameters that are resolved at mapper configuration
    time.
...
class RelationshipProperty(
    ...
    def _get_attr_w_warn_on_none(
        ...
        #
        # * the object hasn't been flushed yet but it has a users-defined
        #   value
        #
        ...
        #
        # * the object has a users-set value, but it's None and we don't do
...
class JoinCondition:
    ...
    def _annotate_local(self) -> None:
        ...
        _annotate_remote() or users-defined.
