...
class Mapper(
    ...
    def __init__(
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          instances; this must be handled by the users,
        ...
        if self.polymorphic_on is not None:
            ...
            if self.polymorphic_on in self._columntoproperty:
                ...
                if col is None:
                    ...
                    # likely a users error if the schema.Column isn't
                    # represented somehow in either persist_selectable or
                    # with_polymorphic.   Otherwise as of 0.7.4 we
                    # just go with it and assume the users wants it
    ...
    def _adapt_inherited_property(self, key, prop, init):
        ...
        if not self.concrete:
            ...
            # mapper and we don't map this.  don't trip users-defined
    ...
    @util.langhelpers.tag_method_for_warnings(
        ...
        "which was invoked automatically in response to a users-initiated "
        "operation.",
        sa_exc.SAWarning,
    )
    ...
    def _should_select_with_poly_adapter(self):
        ...
        # is no users-defined aliased selectable / subquery configured.
...
def configure_mappers() -> None:
    ...
    extensions or users-defined extension hooks.
