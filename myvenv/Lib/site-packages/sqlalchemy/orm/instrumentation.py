...
instrumentation.py deals with registration of end-users classes
...
class ClassManager(
    ...
    def _new_state_if_none(
        ...
        if hasattr(instance, self.STATE_ATTR):
            ...
            # users error situation but allow the object
...
def _generate_init(class_, class_manager, original_init):
    ...
    # Go through some effort here and don't change the users's __init__
