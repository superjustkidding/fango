...
This module is usually not directly visible to users applications, but
...
class QueryableAttribute(
    ...
    def info(self) -> _InfoType:
        ...
        * If the attribute is a :class:`.ColumnProperty` but is mapped to
          ...
          attribute (which should be the case, unless a users-defined SQL
...
def create_proxied_attribute(
    ...
    """Create an QueryableAttribute / users descriptor hybrid.
...
class CollectionAttributeImpl(HasCollectionAdapter, AttributeImpl):
    ...
    InstrumentedCollectionAttribute holds an arbitrary, users-specified
    container object (defaulting to a list) and brokers access to the
    CollectionAdapter, a "view" onto that object that presents consistent bag
    semantics to the orm layer independent of the users data implementation.
