...
class SchemaItem(SchemaVisitable):
    ...
    def info(self) -> _InfoType:
        """Info dictionary associated with the object, allowing users-defined
...
class Table(
            ...
            if the_sentinel_zero.identity:
                ...
                if the_sentinel_zero.nullable:
                    raise exc.InvalidRequestError(
                        ...
                        "users-populated sentinel values will be used."
                    )
                default_characterization = (
    ...
    def to_metadata(
        ...
        E.g.::
            ...
            users = Table("users", m1, Column("id", Integer, primary_key=True))

            m2 = MetaData()
            user_copy = users.to_metadata(m2)
        ...
        :param schema: optional string name indicating the target schema.
         ...
         set explicitly::
            ...
            user_copy_one = users.to_metadata(m2, schema=None)

            m3 = MetaData()  # schema defaults to None

            # user_copy_two will have None as the schema name
            user_copy_two = users.to_metadata(m3, schema=None)
    ...
    def _set_parent(  # type: ignore[override]
        ...
        **kw: Any,
        ...
        if extra_remove and existing_col is not None and self.key == self.name:
            util.warn(
                f'Column with users-specified key "{existing_col.key}" is '
                "being replaced with "
...
class MetaData(HasSchemaAttr):
    ...
    def __init__(
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * the string name of a users-defined "token" that can be used
          ...
          associated with users-defined "token" keys should be callables of the
          ...
          available for certain types of constraint:
            ...
            * users-defined: any additional token may be implemented by passing
...
class Identity(IdentityOptions, FetchedValue, SchemaItem):
    ...
    def __init__(
        ...
        :param always:
          ...
          If ``False`` is specified, the default, then the users-specified
          value takes precedence.
          If ``True`` is specified, a users-specified value is not accepted (
