...
To generate users-defined SQL strings, see
:doc:`/ext/compiler`.
...
class SQLCompiler(Compiled):
    ...
    This attribute is used only for end-users invocation of stmt.compile();
    ...
    def _process_parameters_for_postcompile(
        ...
        * literal_binds compiled with the literal_execute flag.  Used for
        ...
        if _populate_self:
            ...
            # otherwise used internally and is for end-users debugging and
            # special use cases.
    ...
    def _inserted_primary_key_from_lastrowid_getter(self):
        ...
        if autoinc_col is not None:
            ...
            # #7998; honor a non-None users-passed parameter over lastrowid.
        ...
        if existing_cte is not None:
            ...
            if cte is existing_cte._restates or cte is existing_cte:
                ...
                if (
                    ...
                    # differently, or were indicated separately by the users,
                    # with the same name
                    raise exc.CompileError(
