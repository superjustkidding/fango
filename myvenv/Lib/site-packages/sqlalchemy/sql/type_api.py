...
class TypeEngine(Visitable, Generic[_T]):
    ...
    class Comparator(
        ...
        def _adapt_expression(
            ...
            including math operators and users-defined operators, but not
    ...
    def _resolve_for_python_type(
        ...
        The initial use case here is for the ORM to link users-defined
    ...
    def coerce_compared_value(
        ...
        End-users functionality extension here should generally be via
        :class:`.TypeDecorator`, which provides more liberal behavior in that
        it defaults to coercing the other side of the expression into this
        type, thus applying special Python conversions above and beyond those
        needed by the DBAPI to both ides. It also provides the public method
        :meth:`.TypeDecorator.coerce_compared_value` which is intended for
        end-users customization of this behavior.
...
class ExternalType(TypeEngineMixin):
    ...
    of SQLAlchemy within either end-users application code or within
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    def load_dialect_impl(self, dialect: Dialect) -> TypeEngine[Any]:
        ...
        This is an end-users override hook that can be used to provide
    ...
    def copy(self, **kw: Any) -> Self:
        ...
        need to be overridden unless the users-defined :class:`.TypeDecorator`
...
def adapt_type(
    ...
    for t in typeobj.__class__.__mro__[0:-1]:
        ...
        # (it may be a users-defined type)
        return typeobj
