...
def between(
    ...
    .. sourcecode:: sql
        ...
        SELECT id, name FROM users WHERE id BETWEEN :id_1 AND :id_2
...
def column(
    ...
    be invoked with just a name alone, as in::
        ...
        stmt = select(id, name).select_from("users")
    ...
    a working table construct with minimal boilerplate::
        ...
        stmt = select(users.c.description).where(users.c.name == "wendy")
...
def distinct(expr: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    .. sourcecode:: sql
        ...
        SELECT users.id, count(DISTINCT users.name) FROM users
...
def nulls_first(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    .. sourcecode:: sql
        ...
        SELECT id, name FROM users ORDER BY name DESC NULLS FIRST
...
def nulls_last(column: _ColumnExpressionArgument[_T]) -> UnaryExpression[_T]:
    ...
    .. sourcecode:: sql
        ...
        SELECT id, name FROM users ORDER BY name DESC NULLS LAST
