...
class ClauseElement(
    ...
    def self_group(
        ...
        :meth:`self_group` is automatic - end-users code should never
...
class TextClause(
    ...
    def bindparams(
        ...
        **names_to_values: Any,
        ...
        Given a text construct such as::
            ...
            stmt = text(
                "SELECT id, name FROM users WHERE name=:name AND timestamp=:timestamp"
            )
    ...
    def columns(
        ...
        **types: _TypeEngineArgument[Any],
        ...
        history_route to calling :meth:`_expression.FromClause.subquery` as well as
...
class Label(roles.LabeledColumnExprRole[_T], NamedColumn[_T]):
    ...
    def _make_proxy(
        ...
        **kw: Any,
        ...
        # the users would want.   See issue #6090.
