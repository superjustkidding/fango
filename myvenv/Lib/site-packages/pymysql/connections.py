...
try:
    ...
    # KeyError occurs when there's no entry in OS database for a current users.
    DEFAULT_USER = None
...
class Connection:
    ...
    :param auth_plugin_map: A dict of plugin names to a class that processes that plugin.
        ...
        (if no authenticate method) for returning a string from the users. (experimental)
