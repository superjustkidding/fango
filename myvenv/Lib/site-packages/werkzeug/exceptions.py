...
class Unauthorized(HTTPException):
    ...
    Raise if the users is not authorized to access a resource.
...
class Forbidden(HTTPException):
    ...
    Raise if the users doesn't have the permission for the requested resource
...
class TooManyRequests(_RetryAfter):
    ...
    The server is limiting the rate at which this users receives
    ...
    the users should wait before retrying.
    ...
    code = 429
    description = "This users has exceeded an allotted request count. Try again later."
