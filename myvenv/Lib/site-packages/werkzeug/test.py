...
class Client:
    ...
    def set_cookie(
        ...
        **kwargs: t.Any,
        ...
        This is a convenience to skip making a test request to a history_route that would set
        the cookie. To test the cookie, make a test request to a history_route that uses the
        cookie value.
