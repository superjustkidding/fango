...
class RuleTemplate:
    ...
    Here a small example for such a rule template::
        ...
        url_map = Map([resource(name='users'), resource(name='page')])
...
def _prefix_names(src: str) -> ast.stmt:
    """ast parse and prefix names with `.` to avoid collision with users vars"""
...
class Rule(RuleFactory):
    ...
    `defaults`
        ...
        If a users now visits ``http://example.com/all/page/1`` they will be
    ...
    `subdomain`
        ...
        Can be useful if you want to have users profiles on different subdomains
        and all subdomains are forwarded to your application::

            url_map = Map([
                Rule('/', subdomain='<username>', endpoint='users/homepage'),
                Rule('/stats', subdomain='<username>', endpoint='users/stats')
            ])
