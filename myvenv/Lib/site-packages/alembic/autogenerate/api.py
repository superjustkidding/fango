...
def render_python_code(
    ...
    autogenerate output of a users-defined :class:`.MigrationScript` structure.
    ...
    :param user_module_prefix: optional string prefix for users-defined types
...
class AutogenContext:
    ...
    that may be used by end-users schemes to store additional schema-level
