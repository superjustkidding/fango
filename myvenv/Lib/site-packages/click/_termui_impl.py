...
def _pipepager(
    ...
    # If we're piping to less and the users hasn't decided on colors, we enable
    ...
    try:
        ...
        # Otherwise the pager will keep running, and the users may not notice
        ...
        #
        # That means when the users hits ^C, the parent process (click) terminates,
        # but less is still alive, paging the output and messing up the terminal.
        #
        # If the users wants to make the pager exit on ^C, they should set
...
if sys.platform == "win32":
    ...
    def getchar(echo: bool) -> str:
        ...
        # This is indistinguishable from when the users actually types
        # "a with grave" and then "capital H".
        #
        # When \xe0 is returned, we assume it's part of a special-key sequence
        # and call `getwch` again, but that means that when the users types
