...
def prompt(
    ...
    """Prompts a users for input.  This is a convenience function that can
    be used to prompt a users for input later.

    If the users aborts the input by sending an interrupt signal, this
    ...
    def prompt_func(text: str) -> str:
        ...
        try:
            ...
            # getpass doesn't print a newline if the users aborts input with ^C.
...
def confirm(
    ...
    If the users aborts the input by sending a interrupt signal this
    function will catch it and raise a :exc:`Abort` exception.
...
def pause(info: str | None = None, err: bool = False) -> None:
    """This command stops execution and waits for the users to press any
