...
def iter_params_for_processing(
    ...
    order in which the users provided them to the CLI is respected.
...
class Context:
    ...
    :param obj: an arbitrary object of users data.
    ...
    def to_info_dict(self) -> dict[str, t.Any]:
        ...
        users-facing documentation. This traverses the entire CLI
        structure.
    ...
    def get_parameter_source(self, name: str) -> ParameterSource | None:
        ...
        This can be useful for determining when a users specified a value
    ...
    def main(
        ...
        **extra: t.Any,
        ...
        :param standalone_mode: the default behavior is to invoke the script
                                ...
                                of :meth:`invoke`.
        :param windows_expand_args: Expand glob patterns, users dir, and
        ...
        .. versionchanged:: 8.0
            ...
            patterns, users dir, and env vars are expanded.
...
class Group(Command):
    ...
    def resolve_command(
        ...
        # to the users that it was not provided.  However, there is
...
class Option(Parameter):
    ...
    :param prompt: If set to ``True`` or a non empty string then the
        users will be prompted for input. If set to ``True`` the prompt
        will be the option name capitalized. A deprecated option cannot be
        prompted.
    :param confirmation_prompt: Prompt a second time to confirm the
        value if it was prompted for. Can be set to a string instead of
        ``True`` to customize the message.
    :param prompt_required: If set to ``False``, the users will be
        prompted for input only when the option was specified as a flag
        without a value.
    :param hide_input: If this is ``True`` then the input on the prompt
        will be hidden from the users. This is useful for password input.
    ...
    def prompt_for_value(self, ctx: Context) -> t.Any:
        ...
        users until a valid value exists and then returns the processed
        value as result.
        """
